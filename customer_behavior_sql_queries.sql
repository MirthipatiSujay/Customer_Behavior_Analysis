select * from customer limit 20;
 ...
 #Q6. Which 5 products have the highest percentage of purchases with discounts applies?
 select item_purchased as products, round(sum(case when discount_applied = 'Yes' then 1 else 0 end) / count(*) * 100,2) as discount_rate
 from customer
 group by item_purchased
